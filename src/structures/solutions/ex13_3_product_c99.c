...
{
    switch (category) {
        case CATEGORY_COMPUTER: return "コンピューター";
        case CATEGORY_ACCESSORY: return "アクセサーリ";
...
コード 商品名               カテゴリ          価格     在庫     状態
----------------------------------------------------------------------
101    ノートPC             コンピューター    98000円        5個   販売中
102    USBメモリ            アクセサーリ       2500円       20個   販売中
