# 第12章「ビット操作とビットフィールド」の解答例

## 解答の前に

ビット操作は低レベルプログラミングの基本です。
ここでは、各解答例を通じてビット操作の手法を確認します。
...
ハフマン符号化は可変長符号化の代表例です。
頻出文字に短いビット列を割り当てることで圧縮を実現します。

### チャレンジ12-B解答：ブルームフィルター

[ex12_b_bloom_filter.c](ex12_b_bloom_filter.c)

ブルームフィルターは、空間効率の高い確率的データ構造です。
偽陽性は発生しますが、偽陰性は発生しません。
