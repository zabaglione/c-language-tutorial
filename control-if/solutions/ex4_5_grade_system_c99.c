/*
 * ファイル名: ex4_5_grade_system_c99.c
 * 演習4-5: 成績評価システム
...
int main(void)
{
    ...
    double average = (double)total / 3.0;  // 整数演算を避けるため型キャスト
    ...
    // 全科目60点以上の確認（条件演算子を使用）
    int all_passed = (japanese >= 60 && math >= 60 && english >= 60) ? 1 : 0;
    char *result = all_passed ? "合格" : "不合格";
