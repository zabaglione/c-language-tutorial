...
│   ├── pointers/         # 第8章: ポインター基礎
│   ├── arrays-pointers/  # 第9章: 配列とポインター
│   ├── strings/          # 第10章: 文字列処理
│   ├── functions/        # 第11章: 関数
│   ├── bit-operations/   # 第12章: ビット操作とビットフィールド
│   ├── structures/       # 第13章: 構造体とポインター
│   ├── function-pointers/# 第14章: 関数ポインター
...
| 8 | [ポインター基礎](src/pointers/README.md) | アドレス、間接参照、ポインター演算 | C90 |
| 9 | [配列とポインター](src/arrays-pointers/README.md) | 配列とポインターの関係、関数への配列渡し | C90 |
| 10 | [文字列処理](src/strings/README.md) | 文字配列、文字列関数、文字列操作 | C90 |
| 11 | [関数](src/functions/README.md) | 関数定義、引数、戻り値、再帰関数 | C90/C99 |

### 発展レベル（上級編）

構造体、ビット操作、関数ポインター、応用技術

| 章 | タイトル | 主要な学習内容 | 対象規格 |
|---|---------|---------------|---------|
| 12 | [ビット操作とビットフィールド](src/bit-operations/README.md) | ビット演算、ビットマスク、ビットフィールド | C90 |
| 13 | [構造体とポインター](src/structures/README.md) | 構造体定義、構造体ポインター | C90/C11 |
| 14 | [関数ポインター](src/function-pointers/README.md) | 関数ポインター、コールバック関数 | C90 |
...
- **コンパイラー**: GCC 4.9以降またはClang 3.4以降
- **ビルドツール**: GNU Make
...
- [ ] pointers: ポインターの基本理解
- [ ] arrays-pointers: 配列とポインターの関係
- [ ] strings: 文字列処理の理解
- [ ] functions: 関数の作成と使用
- [ ] bit-operations: ビット操作の習得
- [ ] structures: 構造体の活用
- [ ] function-pointers: 関数ポインターの使用
- [ ] advanced: 高度な技術の理解
